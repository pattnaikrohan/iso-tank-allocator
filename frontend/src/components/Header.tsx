...
const Header: React.FC<HeaderProps> = ({ onStartTutorial }) => {
        ...
        <div className="flex flex-col items-end gap-6 pb-1">
          <div className="flex items-center gap-3">
            <button
              ...
              title="App Tutorial"
            >
              <svg className="w-5 h-5 text-emerald-400 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              <span className="text-sm font-mono uppercase tracking-widest font-semibold">Help</span>
            </button>
